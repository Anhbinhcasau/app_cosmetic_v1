...
class Dob {
  ...
  String getDOB() {
    DateTime tempDate =
        new DateFormat("yyyy-MM-ddThh:mm:ss.zzzZ").parse(date ?? "");
    return DateFormat("MMM dd, yyy").format(tempDate);
  }
}
...
class UserListResponse {
  ...
  UserListResponse({this.userItems, this.info});

  UserListResponse.fromJson(Map<String, dynamic> json) {
    if (json['results'] != null) {
      userItems = <UserItem>[];
      json['results'].forEach((v) {
        userItems!.add(UserItem.fromJson(v));
      });
    }
  ...
  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = Map<String, dynamic>();
    data['results'] =
        userItems != null ? userItems!.map((v) => v?.toJson()).toList() : null;
